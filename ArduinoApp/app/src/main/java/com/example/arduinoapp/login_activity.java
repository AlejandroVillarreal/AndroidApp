...
public class login_activity extends AppCompatActivity {
   ...
   private ArrayList dataList;
    ...
    public void change_language(View v){
        final String[] list_of_languages = {"Español","English"};
        AlertDialog.Builder mBuilder = new AlertDialog.Builder(login_activity.this);
        mBuilder.setTitle("Choose Language");
        mBuilder.setSingleChoiceItems(list_of_languages, -1, new DialogInterface.OnClickListener() {
            @Override
    ...
    private void setLocale(String language){
        ...
        //Guardar como sharedPreferences
    ...
    public void loadLocale(){
        ...
        String lang = prefs.getString("My_Language","en");
        setLocale(lang);
    }
}
